...
vignette: >
  %\VignetteIndexEntry{Relative Rigor Score: Interpretation of the Radarchart}
...
The radar chart helps you to see 

- The **width** of each sector corresponds to the **maximal number of rigor points** one could gain. If you often opt-out of certain indicators, then the maximal points get reduced.
...
But in the few cases where he could provide open data, he did it in a perfect way (i.e., according to all FAIR criteria and the other indicators related to open data): The narrow sector has 100% of points.
