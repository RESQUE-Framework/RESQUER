...
params:
  ...
  json_path: "/Users/felix/LMU/DGPs Kommission Open Science/RESQUE/Mainz Test 2/resque_schönbrodt_0.6.0.json"
---
...
pop_sel <- pop_sel |> 
  left_join(applicant$indicators %>% select(doi, Title = title_links_html, RRS_overall, CRediT_involvement, CRediT_involvement_roles), by="doi") %>%
...
'))
  ...
  cat("
::: {.callout-warning title='No ORCID provided - indexes on internationality and interdisciplinarity cannot be computed.'}
:::")
}
```
