...
# params=list(); params$verbose=FALSE; params$anonymous=FALSE; params$randomize = FALSE; params$clear_cache=TRUE; params$json_folder='/Users/felix/Documents/Github/RESQUE-Framework/RESQUER/_test/report_testsuite/jsons'
...
if (params$randomize == TRUE) {
  tab_impact$mean_FNCS <- wiggle(tab_impact$mean_FNCS)
}
