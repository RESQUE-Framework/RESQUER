...
# json_folder: "/Users/felix/LMU/DGPs Kommission Open Science/RESQUE/Overview"
# json_folder: "/Users/felix/Documents/Github/RESQUE-Framework/RESQUER/_test/testCases"
...
for (i in 1:length(applicant_list)) {
  row <- get_RRS_tablerow(applicant_list[[i]], add_scores = TRUE)
...
datatable(
  ...
  options = list(
    ...
    paging = FALSE,
    columnDefs = list(
      list(targets = colnames(tab_RRS)[2], orderData = 2), 
      list(targets = colnames(tab_RRS)[3], orderData = 3),  # Sort OD by RRS_OD (which is the 5th column)
      list(targets = colnames(tab_RRS)[4], orderData = 4),
      list(targets = colnames(tab_RRS)[5], orderData = 5),
      list(targets = colnames(tab_RRS)[6], orderData = 6),  
